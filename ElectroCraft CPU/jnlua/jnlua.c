...
/* ---- Fields ---- */
/* lua_registryindex() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1registryindex(JNIEnv *env, jobject obj) {
	return (jint) LUA_REGISTRYINDEX;
}

/* lua_version() */
JNIEXPORT jstring JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1version(JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1newstate (JNIEnv *env, jobject obj, int apiversion, jlong existing) {
	lua_State *L;
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1close (JNIEnv *env, jobject obj, jboolean ownstate) {
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1gc (JNIEnv *env, jobject obj, jint what, jint data) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1openlib (JNIEnv *env, jobject obj, jint lib) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
...
/* ---- Load and dump ---- */
/* lua_load() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1load (JNIEnv *env, jobject obj, jobject inputStream, jstring chunkname, jstring mode) {
	lua_State *L = getluathread(env, obj);
...
/* lua_dump() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1dump (JNIEnv *env, jobject obj, jobject outputStream) {
	lua_State *L = getluathread(env, obj);
...
/* ---- Call ---- */
/* lua_pcall() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pcall (JNIEnv *env, jobject obj, jint nargs, jint nresults) {
	lua_State *L = getluathread(env, obj);
	int index, status;
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getglobal (JNIEnv *env, jobject obj, jstring name) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1setglobal (JNIEnv *env, jobject obj, jstring name) {
	lua_State *L = getluathread(env, obj);
...
/* ---- Stack push ---- */
/* lua_pushboolean() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushboolean (JNIEnv *env, jobject obj, jint b) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)) {
		lua_pushboolean(L, b);
	}
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushbytearray (JNIEnv *env, jobject obj, jbyteArray ba) {
	lua_State *L = getluathread(env, obj);
...
/* lua_pushinteger() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushinteger (JNIEnv *env, jobject obj, jint n) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)) {
		lua_pushinteger(L, n);
	}
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushjavafunction (JNIEnv *env, jobject obj, jobject f) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checknotnull(f)) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushjavaobject (JNIEnv *env, jobject obj, jobject object) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checknotnull(object)) {
...
/* lua_pushnil() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushnil (JNIEnv *env, jobject obj) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)) {
		lua_pushnil(L);
	}
...
/* lua_pushnumber() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushnumber (JNIEnv *env, jobject obj, jdouble n) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)) {
		lua_pushnumber(L, n);
	}
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushstring (JNIEnv *env, jobject obj, jstring s) {
	lua_State *L = getluathread(env, obj);
...
/* ---- Stack type test ---- */
/* lua_isboolean() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isboolean (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_iscfunction() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1iscfunction (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_isfunction() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isfunction (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
/* lua_isjavafunction() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isjavafunction (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isjavaobject (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_isnil() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isnil (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
/* lua_isnone() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isnone (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	return (jint) !validindex(L, index);
}

/* lua_isnoneornil() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isnoneornil (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 1;
	}
...
/* lua_isnumber() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isnumber (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
/* lua_isstring() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isstring (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
/* lua_istable() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1istable (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
/* lua_isthread() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1isthread (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1compare (JNIEnv *env, jobject obj, jint index1, jint index2, jint op) {
	lua_State *L = getluathread(env, obj);
...
/* lua_rawequal() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawequal (JNIEnv *env, jobject obj, jint index1, jint index2) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index1) || !validindex(L, index2)) {
		return (jint) 0;
	}
...
/* lua_rawlen() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawlen (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	size_t result = 0;
...
/* lua_toboolean() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1toboolean (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return 0;
	}
...
JNIEXPORT jbyteArray JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tobytearray (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	jbyteArray ba;
	jbyte *b;
	size_t tobytearray_length;
...
/* lua_tointeger() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tointeger (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_tointegerx() */
JNIEXPORT jobject JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tointegerx (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	lua_Integer result = 0;
	int isnum = 0;
	if (checkindex(L, index)) {
...
JNIEXPORT jobject JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tojavafunction (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT jobject JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tojavaobject (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_tonumber() */
JNIEXPORT jdouble JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tonumber (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_tonumberx() */
JNIEXPORT jobject JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tonumberx (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	lua_Number result = 0.0;
	int isnum = 0;
	if (checkindex(L, index)) {
...
/* lua_topointer() */
JNIEXPORT jlong JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1topointer (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT jstring JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tostring (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_type() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1type (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (!validindex(L, index)) {
		return LUA_TNONE;
	}
...
/* ---- Stack operations ---- */
/* lua_absindex() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1absindex (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1arith (JNIEnv *env, jobject obj, jint op) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1concat (JNIEnv *env, jobject obj, jint n) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
...
/* lua_copy() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1copy (JNIEnv *env, jobject obj, jint from_index, jint to_index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_gettop() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1gettop (JNIEnv *env, jobject obj) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1len (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checkindex(L, index)) {
		index = lua_absindex(L, index);
...
/* lua_insert() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1insert (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_pop() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pop (JNIEnv *env, jobject obj, jint n) {
	lua_State *L = getluathread(env, obj);
...
/* lua_pushvalue() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1pushvalue (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checkindex(L, index)) {
		lua_pushvalue(L, index);
...
/* lua_remove() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1remove (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkrealindex(L, index)) {
		lua_remove(L, index);
	}
...
/* lua_replace() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1replace (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkindex(L, index)
			&& checknelems(L, 1)) {
		lua_replace(L, index);
...
/* lua_settop() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1settop (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1createtable (JNIEnv *env, jobject obj, jint narr, jint nrec) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getsubtable (JNIEnv *env, jobject obj, jint index, jstring fname) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getfield (JNIEnv *env, jobject obj, jint index, jstring k) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1gettable (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
		index = lua_absindex(L, index);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1newtable (JNIEnv *env, jobject obj) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)) {
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1next (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	jint next_result = 0;
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
...
/* lua_rawget() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawget (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
/* lua_rawgeti() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawgeti (JNIEnv *env, jobject obj, jint index, jint n) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawset (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)
			&& checknelems(L, 2)) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1rawseti (JNIEnv *env, jobject obj, jint index, jint n) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
		index = lua_absindex(L, index);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1settable (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)
			&& checknelems(L, 2)) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1setfield (JNIEnv *env, jobject obj, jint index, jstring k) {
	lua_State *L = getluathread(env, obj);
...
/* ---- Metatable ---- */
/* lua_getmetatable() */
JNIEXPORT int JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getmetatable (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	int result = 0;
	if (lua_checkstack(L, JNLUA_MINSTACK)
			&& checkindex(L, index)) {
...
/* lua_setmetatable() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1setmetatable (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	if (checkindex(L, index)
			&& checknelems(L, 1)
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getmetafield (JNIEnv *env, jobject obj, jint index, jstring k) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1newthread (JNIEnv *env, jobject obj) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
...
/* lua_resume() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1resume (JNIEnv *env, jobject obj, jint index, jint nargs) {
...
/* lua_status() */
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1status (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	int result = 0;
	if (checktype(L, index, LUA_TTHREAD)) {
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1ref (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
	jint ref_result = 0;
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1unref (JNIEnv *env, jobject obj, jint index, jint ref) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)) {
		index = lua_absindex(L, index);
...
/* ---- Debug ---- */
/* lua_getstack() */
JNIEXPORT jobject JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getstack (JNIEnv *env, jobject obj, jint level) {
	lua_State *L = getluathread(env, obj);
	lua_Debug *ar = NULL;
	jobject result = NULL;
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1getinfo (JNIEnv *env, jobject obj, jstring what, jobject ar) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT jint JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tablesize (JNIEnv *env, jobject obj, jint index) {
	lua_State *L = getluathread(env, obj);
...
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_lua_1tablemove (JNIEnv *env, jobject obj, jint index, jint from, jint to, jint count) {
	lua_State *L = getluathread(env, obj);
	if (checkstack(L, JNLUA_MINSTACK)
			&& checktype(L, index, LUA_TTABLE)
...
/* ---- Debug structure ---- */
/* lua_debugfree() */
JNIEXPORT void JNICALL Java_me_querol_com_naef_jnlua_LuaState_00024LuaDebug_lua_1debugfree (JNIEnv *env, jobject obj) {
...
/* lua_debugname() */
JNIEXPORT jstring JNICALL Java_me_querol_com_naef_jnlua_LuaState_00024LuaDebug_lua_1debugname (JNIEnv *env, jobject obj) {
	lua_Debug *ar = getluadebug(env, obj);
	return ar != NULL && ar->name != NULL ? (*env)->NewStringUTF(env, ar->name) : NULL;
}

/* lua_debugnamewhat() */
JNIEXPORT jstring JNICALL Java_me_querol_com_naef_jnlua_LuaState_00024LuaDebug_lua_1debugnamewhat (JNIEnv *env, jobject obj) {
	lua_Debug *ar = getluadebug(env, obj);
...
JNIEXPORT jint JNICALL JNI_OnLoad (JavaVM *vm, void *reserved) {
	...
	if (!(luastate_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaState"))
	...
	if (!(luadebug_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaState$LuaDebug"))
	...
	if (!(javafunction_interface = referenceclass(env, "me/querol/com/naef/jnlua/JavaFunction"))
			|| !(invoke_id = (*env)->GetMethodID(env, javafunction_interface, "invoke", "(Lme/querol/com/naef/jnlua/LuaState;)I"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luaruntimeexception_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaRuntimeException"))
			|| !(luaruntimeexception_id = (*env)->GetMethodID(env, luaruntimeexception_class, "<init>", "(Ljava/lang/String;)V"))
			|| !(setluaerror_id = (*env)->GetMethodID(env, luaruntimeexception_class, "setLuaError", "(Lme/querol/com/naef/jnlua/LuaError;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luasyntaxexception_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaSyntaxException"))
			|| !(luasyntaxexception_id = (*env)->GetMethodID(env, luasyntaxexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luamemoryallocationexception_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaMemoryAllocationException"))
			|| !(luamemoryallocationexception_id = (*env)->GetMethodID(env, luamemoryallocationexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luagcmetamethodexception_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaGcMetamethodException"))
			|| !(luagcmetamethodexception_id = (*env)->GetMethodID(env, luagcmetamethodexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luamessagehandlerexception_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaMessageHandlerException"))
			|| !(luamessagehandlerexception_id = (*env)->GetMethodID(env, luamessagehandlerexception_class, "<init>", "(Ljava/lang/String;)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luastacktraceelement_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaStackTraceElement"))
			|| !(luastacktraceelement_id = (*env)->GetMethodID(env, luastacktraceelement_class, "<init>", "(Ljava/lang/String;Ljava/lang/String;I)V"))) {
		return JNLUA_JNIVERSION;
	}
	if (!(luaerror_class = referenceclass(env, "me/querol/com/naef/jnlua/LuaError"))
			|| !(luaerror_id = (*env)->GetMethodID(env, luaerror_class, "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V"))
			|| !(setluastacktrace_id = (*env)->GetMethodID(env, luaerror_class, "setLuaStackTrace", "([Lme/querol/com/naef/jnlua/LuaStackTraceElement;)V"))) {
		return JNLUA_JNIVERSION;
	}
