...
static int create_vm (lua_State *L) {
	...
	if (!(luastate_class = (*env)->FindClass(env, "me/querol/com/naef/jnlua/LuaState"))
	...
	if (!(library_class  = (*env)->FindClass(env, "me/querol/com/naef/jnlua/LuaState$Library"))
			|| !(openlib_id = (*env)->GetMethodID(env, luastate_class, "openLib", "(Lme/querol/com/naef/jnlua/LuaState$Library;)V"))
			|| !(java_id = (*env)->GetStaticFieldID(env, library_class, "JAVA", "Lme/querol/com/naef/jnlua/LuaState$Library;"))
